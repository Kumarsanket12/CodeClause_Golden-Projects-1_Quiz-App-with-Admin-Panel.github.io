var questions = [
    {
        question: "Which of the following Article of the Indian Constitution states'Equality of Opportunity in public employment'?",
        answer: "Article 16",
        options: [
            "Article 16",
            "Article 17",
    ...
    {
        question: " Which of the following diseases is caused by the deficiency of Vitamin C?",
    ...
    {
        question: "What was the first vaccine to be developed against a contagious disease?",
...
function loginButton() {
    ...
    if (username.value === "sanket" && password.value === "sanket060") {
